            ...
            <div className="text-center py-12 bg-white rounded-lg border border-gray-200">
              <p className="text-gray-400 text-lg">
                {filter
                  ...
                  : "No historical data available yet for this market."}
              </p>
            </div>
          ) : (
                  ...
                  >
                    ...
                    <div className="mb-4">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <span className={`text-lg font-bold ${getProbabilityBgColor(stat.probability)} px-3 py-1 rounded-full text-sm`}>
